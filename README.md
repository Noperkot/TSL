...
Сам скачает все необходимые компоненты (TorrServer+Launcher), разложит по папкам, создаст ярлыки и добавит в исключения брандмауэра(при наличии администраторских прав). Есть возможность обновления/отката версий торрсервера.  
<br/>
